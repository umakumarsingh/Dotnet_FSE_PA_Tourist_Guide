...
namespace TouristGuide.Test.Testcases
{
    public class BoundaryTest
    {
        ...
        /// <summary>
        /// Testfor_Validate_tourId is used to test TourId is valid or not
        /// </summary>
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_tourGuideId()
        {
            //Arrange
            bool res = false;
            //Act
            tourService.Setup(repo => repo.HireTourGuide(_tourGuide)).ReturnsAsync(_tourGuide);
            var result = await _tourGS.HireTourGuide(_tourGuide);

            if (result.TourId.Length.ToString() == _tourGuide.TourId.Length.ToString())
            {
                res = true;
            }
            //Asert
            //final result displaying in text file
            await File.AppendAllTextAsync("../../../../output_boundary_revised.txt", "Testfor_Validate_tourGuideId=" + res + "\n");
            return res;
        }
        /// <summary>
        /// Testfor_Validate_placeId is used to test PlaceId is valid or not
        /// </summary>
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_AddNewPlace_Id()
        {
            //Arrange
            bool res = false;
            //Act
            ...
            if (result.PlaceId.Length.ToString() == _place.PlaceId.Length.ToString())
            {
                res = true;
            }
            //Asert
            //final result displaying in text file
            await File.AppendAllTextAsync("../../../../output_boundary_revised.txt", "Testfor_Validate_AddNewPlace_Id=" + res + "\n");
            return res;
        }
        /// <summary>
        /// Testfor_Validate_DestinationId is used to test DestinationId is valid or not
        /// </summary>
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_AddNewDestination_Id()
        {
            //Arrange
            bool res = false;
            //Act
            ...
            if (result.DestinationId.Length.ToString() == _destination.DestinationId.Length.ToString())
            {
                res = true;
            }
            //Asert
            //final result displaying in text file
            await File.AppendAllTextAsync("../../../../output_boundary_revised.txt", "Testfor_Validate_AddNewDestination_Id=" + res + "\n");
            return res;
        }
        /// <summary>
        /// Testfor_Validate_AboutIndiaId is used to test Id is valid or not
        /// </summary>
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_AboutIndia_Id()
        {
            //Arrange
            bool res = false;
            //Act
            ...
            if (result.Id.Length.ToString() == _aboutIndia.Id.Length.ToString())
            {
                res = true;
            }
            //Asert
            //final result displaying in text file
            await File.AppendAllTextAsync("../../../../output_boundary_revised.txt", "Testfor_Validate_AboutIndia_Id=" + res + "\n");
            return res;
        }
    }
}
